...
class BarberiaController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        $data = Barberia::all()->where('user_id', 'or' ,$user_id );
      
        if ($request->ajax()) {
            
          //  $barberia = Barberia::with('servicios');
            ...
            return Datatables::of($data)
                   ...
                   /* ->editColumn('servicios', function($barberia){

                        return ($barberia->servicios->count() !== null) ? $barberia->servicios->count() : $barberia->servicios->count();
